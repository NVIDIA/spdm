...
ENUM_VALUE(RetStat, ERROR_CERTIFICATE_CHAIN_DIGEST_INVALID, -10)
ENUM_VALUE(RetStat, ERROR_CERTIFICATE_CHAIN_VERIFIY_FAILED, -11)
ENUM_VALUE(RetStat, ERROR_AUTHENTICATION_FAILED, -12)
ENUM_VALUE(RetStat, ERROR_MEASUREMENT_SIGNATURE_VERIFIY_FAILED, -13)
ENUM_VALUE(RetStat, ERROR_MISSING_CAPABILITY_CERT, -14)
ENUM_VALUE(RetStat, ERROR_MISSING_CAPABILITY_CHAL, -15)
ENUM_VALUE(RetStat, ERROR_MISSING_CAPABILITY_MEAS, -16)
ENUM_END()
...
ENUM_VALUE(SignatureEnum, RSASSA_2048, 1)
ENUM_VALUE(SignatureEnum, RSAPSS_2048, 2)
ENUM_VALUE(SignatureEnum, RSASSA_3072, 3)
ENUM_VALUE(SignatureEnum, RSAPSS_3072, 4)
ENUM_VALUE(SignatureEnum, RSASSA_4096, 5)
ENUM_VALUE(SignatureEnum, RSAPSS_4096, 6)
ENUM_VALUE(SignatureEnum, ECDSA_ECC_NIST_P256, 7)
ENUM_VALUE(SignatureEnum, ECDSA_ECC_NIST_P384, 8)
ENUM_VALUE(SignatureEnum, ECDSA_ECC_NIST_P521, 9)
